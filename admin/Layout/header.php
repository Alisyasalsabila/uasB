            ...
            <div class="row">
                ...
                <div class="col-xl-6 col-lg-7">
                    <nav class="header__menu">
                        <ul>
                            <li class="active"><a href="../admin/tampilan_admin.php">Beranda</a></li>
                            <li><a href="../admin/barang.php">Barang</a></li>
                            <li><a href="../admin/riwayat_pembelian.php">Riwayat Pembelian</a></li> 
